 ...
 */
public class EstrategiaCancelarPrimeiraClasse implements EstrategiaCancelarReserva {

    @Override
    public void cancelarReserva(Voo voo, Reserva reserva) throws ClasseIncorretaException {
        if(Classe.PRIMEIRA.equals(reserva.getClasse())
                && voo.getAeronave() instanceof AeronaveComPrimeiraClasse) {
